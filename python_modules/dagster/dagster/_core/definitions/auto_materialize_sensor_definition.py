...
class AssetAutomationSensorDefinition(SensorDefinition):
    def __init__(
        self,
        name: str,
        *,
        ...
        """Experimental variant of AutoMaterializeSensorDefinition that evaluates conditions in
        user code.
        """
        self._run_tags = normalize_tags(run_tags).tags
    ...
    @property
    def sensor_type(self) -> SensorType:
        return SensorType.ASSET_AUTOMATION
